...
COLLECT_GCC_OPTIONS='-o' 'test' '-save-temps' '-v' '-mtune=generic' '-march=x86-64'
 /usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/cc1 -E -quiet -v test.c -mtune=generic -march=x86-64 -fpch-preprocess -o test.i
...
End of search list.
COLLECT_GCC_OPTIONS='-o' 'test' '-save-temps' '-v' '-mtune=generic' '-march=x86-64'
 /usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/cc1 -fpreprocessed test.i -quiet -dumpbase test.c -dumpbase-ext .c -mtune=generic -march=x86-64 -version -o test.s
